...
const saveDeviceDetailsSchema = Joi.object({
  deviceType: Joi.string().valid("android", "iOS", "web").required().messages({
    ...
    "any.only": "Device Type must be either 'android', 'iOS', or 'web'.",
    "any.required": "Device Type is required.",
  }),

  deviceToken: Joi.alternatives().conditional("deviceType", {
    switch: [
      {
        is: "web",
      ...
      {
        is: Joi.valid("android", "iOS"),
        then: Joi.string().trim().required().messages({
          "string.empty": "Device Token is required for mobile devices.",
        }),
      },
    ],
  ...
  modelName: Joi.alternatives().conditional("deviceType", {
    switch: [
      {
        is: Joi.valid("android", "iOS"),
        then: Joi.string().trim().required().messages({
          "string.empty": "Model Name is required for mobile devices.",
        }),
      },
      {
        is: "web",
