...
router.get('/details/:id',verifyJWT,getProjectById);
...
router.get('/project-tasks/:projectId',verifyJWT,getProjectTaskAndAssignUsers)
...
router.get('/assign-tasks/:projectId',verifyJWT,getProjectAssignTasks);
...
router.get('/quality-assurance/:projectId',verifyJWT,getQualityAssuranceByProjectId);

// Project Invoice
router.get('/invoice', verifyJWT, ProjectInvoices);
router.put('/invoices/:invoiceId', verifyJWT, updateInvoiceStatus);
router.get('/invoice/:projectTaskId',verifyJWT,getProjectTaskInvoices);
router.get('/invoices/:projectId',verifyJWT,getInvoicesByProjectId);
...
router.get('/get-project-tasks/:projectId',verifyJWT,getProjectTasks);
